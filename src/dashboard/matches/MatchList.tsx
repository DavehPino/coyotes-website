...
/** Lista agrupada por mes: filas separadas por filetes, cada una enlaza al detalle. */
              ...
              return (
                <li key={match.id}>
                  <Link
                    ...
                    className={[
                      'group grid min-h-16 grid-cols-[4.25rem_minmax(0,1fr)_auto_auto] items-center gap-3 px-1 py-2',
                  ...
                  >
                    <span aria-hidden className="flex flex-col leading-tight uppercase">
                      <span className="text-lg font-extrabold whitespace-nowrap text-ink">{formatDayMonth(match.played_on)}</span>
                    ...
                    <span className="flex items-center gap-2">
                      <span className={`font-figures text-3xl leading-none font-black ${OUTCOME_TEXT_CLASSES[match.outcome]}`}>
                        {ourScoreLabel(match)}
                      </span>
